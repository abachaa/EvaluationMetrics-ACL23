...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="dictionary of weights for medical words",
    )

    parser.add_argument(
        "-wc",
        "--weights_per_row_cands",
        default= None, 
        type=str,
        required=False,
        help="weights for candidcate medical words",
    )
    ...
    parser.add_argument(
        ...
        type=bool,
        required=False,
        help="sliding window policy flag",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="dictionary of weights for reference medical words",
    )
    ...
    all_preds, hash_code = bert_score.score(
        ...
        semantic_dictionary = args.semantic_dictionary,
        weights_per_row_cands = args.weights_per_row_cands,
        weights_per_row_ref = args.weights_per_row_ref, sliding_window_flag= args.sliding_window_flag
    )
